                        ...
                        <div class="tile-body">
                            <form class="row" action="add-investment-costs-servlet" method="post" id="form-1">
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" type="number" min="0" placeholder="Thêm số tiền đầu tư (VND)" name="price" required>                               
                                </div>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input class="form-control" value="${requestScope.inforOfUser.getFullName()}" readonly="">
                                    <input class="form-control" value="${requestScope.inforOfUser.getAccountID()}" type="hidden" name="managerId" >                                   
                                </div>
                                <div class="form-group col-md-4">
