 ...
 * @author admin
 */
public class AddTypeOfInvestmentCostServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet AddTypeOfInvestmentCostServlet</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet AddTypeOfInvestmentCostServlet at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        //request.setAttribute("listType", listTypeOfInvestmentCosts);
        request.getRequestDispatcher("view/landlord/add-type-of-investment-costs.jsp").forward(request, response);
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if (checkName == true) {
            TypeOfInvestmentCosts typeOfInvestmentCosts = new TypeOfInvestmentCosts(name);
            tyeOfInvestmentCostsDAO.insertTypeOfInvestmentCost(typeOfInvestmentCosts);
