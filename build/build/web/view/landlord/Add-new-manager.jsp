              ...
              <form id="addLodgingForm" action="add-new-manager-house" method="post">
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label class="control-label">Tên email<span style="color:red;">(*)</span></label>
                           <select class="form-control" id="phuong" name="email"  required>
                                <c:forEach items="${requestScope.listAc}" var="account">
                                <option value="${account.getAccountID()}">${account.getEmail()}</option>
                                </c:forEach>
                            </select>
                        </div>                  
                        <div class="form-group col-md-6">
                         ...
                         <div class="form-group col-md-6">
                            <label for="phuong">Nhà trọ</label>
                            <select class="form-control" id="" name="nhatro"  required>
