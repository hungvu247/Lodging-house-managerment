...
<html lang="en">
    ...
    <body onload="time()" class="app sidebar-mini rtl">
                                        ...
                                        <c:forEach items="${sessionScope.pagination.getListObject()}" var="list">
                                            <tr>
                                                ...
                                                <td><button class="btn btn-primary btn-sm trash" type="button" title="Xóa"
                                                            onclick="myFunction('${list.staffID}')"><i class="fas fa-trash-alt"></i> 
                                                    </button>
                                                    <a class="btn btn-primary btn-sm edit" title="Sửa" href="load-data-staff?staffID=${list.getStaffID()}"><i class="fas fa-edit"></i></a>
                                                </td>
                                            </tr>
                                        </c:forEach>
        ...
        <script>
            ...
            var hasData = false; // Biến kiểm tra xem đã có dữ liệu hay chưa
