        ...
        <main class="app-content">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="tile">
                        <form action="update-role-of-staff" method="POST">
                            ...
                            <div class="tile-body">
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" type="text" value="${requestScope.updateRole.roleStaffName}" readonly>
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="control-label">Tên chức vụ mới</label>
                                    <input class="form-control" id="roleName" type="text" maxlength="150" name="rolenamestaff" required>
