        ...
        <main class="app-content">
            <div class="app-title">
                <ul class="app-breadcrumb breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#">Chỉnh sửa chi phí đầu tư</a></li>
                </ul>
            </div>
            <div class="row">
                <div class="col-md-12">
                    <div class="tile">
                        ...
                        <div class="tile-body">
                            <form class="row" action="update-investment-costs-servlet" method="post">
                                <div class="form-group col-md-6">
                                    <label class="control-label">Số tiền đầu tư</label>
                                    <input class="form-control" type="number" min="0"  value="${requestScope.investmentCost.getPrice()}" placeholder="Thêm số tiền đầu tư" name="price" required="">
                                    <input type="hidden" value="${requestScope.investmentCost.getInvestmentCostID()}" name="investmentCostId">
                                </div>
                                <div class="form-group col-md-6">
                                    <label class="control-label">Miêu tả</label>
                                    <input class="form-control" type="text" id="inputField" value="${requestScope.investmentCost.getDescription()}"  placeholder="Thêm miêu tả" name="description" required="">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input class="form-control" value="${requestScope.informanager.getFullName()}" readonly="">
                                </div>
                                <div class="form-group col-md-4">
