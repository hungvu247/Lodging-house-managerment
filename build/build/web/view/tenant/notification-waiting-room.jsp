                        ...
                        <div class="slider_active owl-carousel">
                            <c:forEach var="l" items="${requestScope.list}">
                                ...
                                <div class="single_slider">
                                    <div class="background_image" style="background-image: url('<c:out value="${l.getImg()}"/>');"></div>
                                    <div class="slider_content">
                                        <div class="slider_content_inner">
                                            <h1 style="color:lightsalmon;font-size:28px;margin-top: 20px;"><c:out value="${l.getNameLodgingHouse()}"/></h1>
                                            <p style="color:lightsalmon;font-size:15px;"><c:out value="${l.getProvince()}-${l.getDistrict()}-${l.getWard()}"/></p>
                                        </div>
                                    </div>
                                </div>
                            </c:forEach>
