...
public class StaffDAO extends DBContext {
    ...
    public List<Staff> getAllStaff(int lodgingHouseID) {
        ...
        String sql = "SELECT * FROM Staff WHERE LodgingHouseID = ?";
        try {
    ...
    public boolean checkExistPhoneNumber(int staffID, String phoneNumber) {
        ...
        String sql = "SELECT phoneNumber FROM Staff WHERE staffID = ?";
        try {
            PreparedStatement stm = connection.prepareStatement(sql);
