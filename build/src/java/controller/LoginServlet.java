...
public class LoginServlet extends HttpServlet {
            ...
            if (service.equals("verifyAccount")) {
                ...
                if (account != null) {
                    ...
                    if (insertAccount(request, response, account)) {
                        ...
                        InformationOfUser informationOfUser = new InformationOfUser(accountID, true);
    ...
    public void registerAccount(HttpServletRequest request, HttpServletResponse response) throws IOException, ParseException {
        ...
        Account account = new Account(email, username, password, 3, "username");
        ...
        if (ad.checkUsernameAndPassword(username, password)) {
            ...
            switch (roleId) {
                ...
                case 2 -> {
                    ...
                    int lodgingID = lodgingHousesDAO.getLodgingHouseByManageID(accountLogged.getAccountID());
