...
public class LodgingHousesDAO extends DBContext {
    ...
    public List<LodgingHouse> getAllLodgingHouse() {
        String sql = "select *from LodgingHouses  where StatusDelete=?";
    ...
    public List<LodgingHouse> searchLodgingHouses(String searchInfo) {
        String sql = "SELECT * FROM [LHMS1].[dbo].[LodgingHouses] WHERE "
                + "(NameLodgingHouse LIKE ? OR "
                + "Province LIKE ? OR "
                + "District LIKE ? OR "
                + "Ward LIKE ? OR "
                + "AddressDetail LIKE ?) and StatusDelete=1 ";
    ...
    public List<LodgingHouse> searchLodgingHousesByManagerId(String id) {
        String sql = "SELECT * FROM [LHMS1].[dbo].[LodgingHouses] WHERE "
                + "ManageId=?";
    ...
    public int countsearchLodgingHousesByDate(String dateMin, String dateMax) {
        String sql = """
                     SELECT COUNT(*)
    ...
    public List<LodgingHouse> searchLodgingHousesByDate(String dateMin, String dateMax) {
        String sql = "SELECT *"
                + "  FROM [dbo].[LodgingHouses] where StatusDelete=1  and [Order_Date] between ? and ? ";
    ...
    public static void main(String[] args) throws SQLException {
        ...
        List<LodgingHouse> list = dao.getLodgingHouseByManagerEmpty();
