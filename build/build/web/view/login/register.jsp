...
<html lang="vi">
    ...
    <body>
                    ...
                    <form action="/ManageLodgingHouse/LoginServlet" method="post" style="display: flex" id="form-register">
                        <div class="login100-pic js-tilt" data-tilt style="margin-right: 15px">
                            ...
                            <div class="wrap-input100 validate-input password">
                                ...
                                <span toggle="#password-field" class="bx fa-fw bx-hide field-icon click-eye" id="show-pass"></span>
                                <span class="focus-input100"></span>
                                <span class="symbol-input100">
                                    <i class='bx bx-key'></i>
                                </span>
                            ...
                            <div class="wrap-input100 validate-input">
                                <input autocomplete="off" class="input100" type="text" placeholder="Họ và Tên"
                                       name="fullname" id="fullname" maxlength="31" required="">                                  
                                <span class="focus-input100"></span>
                                <span class="symbol-input100">
                            ...
                            <div class="wrap-input100 validate-input">
                                <input autocomplete="off" class="input100" type="text" placeholder="Số điện thoại"
                                       name="phone" id="phone-number" maxlength="16" required="">     
                                <span class="focus-input100"></span>
                                <span class="symbol-input100">
                            ...
                            <div class="wrap-input100 validate-input">
                                <input autocomplete="off" class="input100" type="date" placeholder="Ngày sinh"
                                       name="dob" id="dob">                              
                                <span class="focus-input100"></span>
                                <span class="symbol-input100">
                        ...
                        <!-- -------------------------------------------------------------------- -->
                        <!-- -------------------------------------------------------------------- -->
                        <div class="login100-form validate-form" style="margin-left: 15px">                         

                            <div class="wrap-input100 validate-input">   
                                <select autocomplete="off" class="input100" name="gender" id="password-field">
                            ...
                            <div class="wrap-input100 validate-input">
                                <input autocomplete="off" class="input100" type="text" placeholder="Căn cước công dân"
                                       name="cic" id="cic" maxlength="13" required="">                              
                                <span class="focus-input100"></span>
                                <span class="symbol-input100">
                                    <i class='bx bx-id-card'></i>
                                </span>
                            ...
                            <div class="wrap-input100 validate-input">   
                                <select autocomplete="off" class="input100" name="province" id="tinh" required="">
                            ...
                            <div class="wrap-input100 validate-input">   
                                <select autocomplete="off" class="input100" name="distract" id="quan" required="">
                            ...
                            <div class="wrap-input100 validate-input">   
                                <select autocomplete="off" class="input100" name="ward" id="phuong" required="">
                            ...
                            <div class="wrap-input100 validate-input">
                                <input autocomplete="off" class="input100" type="text" placeholder="Địa chỉ cụ thể"
                                       name="address-detail" id="password-field">                              
                                <span class="focus-input100"></span>
                                <span class="symbol-input100">
                                    <i class='bx bx-task'></i>
                                </span>
        ...
        <script type="text/javascript">
            ...
            const phoneEle = document.getElementById('phone-number');
            const fullnameEle = document.getElementById('fullname');
            const cicEle = document.getElementById('cic');
            ...
            document.addEventListener('DOMContentLoaded', (event) => {
                ...
                // validate length and numeric of cic           
                validateLengthInput(phoneEle, 'SĐT không được quá 15 kí tự');
                validateNumeric(phoneEle, 'Vui lòng nhập số');

                // validate length and numeric of phonenumber           
                validateLengthInput(cicEle, 'CCCD không được quá 12 kí tự');
                validateNumeric(cicEle, 'Vui lòng nhập số');
            });
            ...
            function checkValidate() {
                ...
                if (fullnameValue === '') {
                    setError(fullnameEle, 'Họ và tên không được để trống');
                    isCheck = false;
                } else {
                    setSuccess(fullnameEle, 'Hợp lệ');
                }
                ...
                if (phoneValue === '') {
                    ...
                    setSuccess(phoneEle, 'Hợp lệ');
                }

                if (!validateDOB()) {
                    setError(dobEle, 'Chắc chắn rằng ngày sinh của bạn hợp lệ');
                    isCheck = false;
                }
...
//                                });
            ...
            function validateDOB() {
                const valueDOB = dobEle.value;

                if (valueDOB === '') {
                    return true;
                }

                // Chuyển giá trị này thành đối tượng Date
                const selectedDate = new Date(valueDOB);
...
//            }
        ...
        <script type="text/javascript">
            ...
            document.getElementById('show-pass').addEventListener('click', function () {
                ...
                const check = document.getElementsByClassName('bx-hide');
