...
public class ManagementLodgingHouses extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        int endPage = countLodgingHouse / 6;
        if (countLodgingHouse % 6 != 0) {
            endPage++;
        }
        ...
        request.getRequestDispatcher("view/landlord/Management-lodging-houses.jsp").forward(request, response);
